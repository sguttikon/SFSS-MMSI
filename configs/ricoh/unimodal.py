...
if C.mapping_name == 'Stanford2D3DS':
    ...
    C.log_dir = osp.abspath(osp.join(C.root, 'workdirs', 'Stanford2D3DS_1024x512/log_' + C.mapping_name + '_' + C.backbone + f'_DMLPDecoderV2_{C.fold}'))
    ...
    C.log_dir = osp.abspath(osp.join(C.root, 'workdirs', 'Structured3D_1024x512/log_' + C.mapping_name + '_' + C.backbone + '_DMLPDecoderV2'))
else:
