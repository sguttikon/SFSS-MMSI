...
C.modality_x = ['camera-depth-1K', 'camera-normals-1K']
...
if C.modality_x[0] == 'camera-depth-1K' and C.modality_x[1] == 'camera-normals-1K':
    C.log_dir = osp.abspath(osp.join(C.root, 'workdirs', 'Stanford2D3DS_1024x512/log_' + C.dataset_name + '_' + C.backbone + f'_DMLPDecoderV2_Depth_Normal_{C.fold}'))
else:
