...
C.log_dir = osp.abspath(osp.join(C.root, 'workdirs', 'Stanford2D3DS_1024x512/log_' + C.dataset_name + '_' + C.backbone + f'_DMLPDecoderV2_{C.fold}'))
