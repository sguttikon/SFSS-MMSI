...
C.rgb = 'rgb-1K'
C.ann = 'semantic-1K'
C.modality_x = ['depth-1K'] # TODO: change to 'depth-1K', 'normal-1K'
...
if C.modality_x[0] == 'depth-1K':
    C.log_dir = osp.abspath(osp.join(C.root, 'workdirs', 'Matterport3D_1024x512/log_' + C.dataset_name + '_' + C.backbone + '_DMLPDecoderV2_Depth'))
elif C.modality_x[0] == 'normal-1K':
    C.log_dir = osp.abspath(osp.join(C.root, 'workdirs', 'Matterport3D_1024x512/log_' + C.dataset_name + '_' + C.backbone + '_DMLPDecoderV2_Normal'))
else:
